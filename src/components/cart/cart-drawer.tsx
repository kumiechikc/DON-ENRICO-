          ...
          <>
            ...
            <div className="p-4 border-t border-white/5 space-y-3">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3.5 rounded-lg fire-gradient text-white font-bold text-sm hover:opacity-90 transition-opacity"
              >
